 ...
 */
final class Version20231023074437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE container ADD name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE contract ADD name VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE sensor ADD name VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contract DROP name');
        $this->addSql('ALTER TABLE container DROP name');
        $this->addSql('ALTER TABLE "group" DROP name');
        $this->addSql('ALTER TABLE sensor DROP name');
    }
}
